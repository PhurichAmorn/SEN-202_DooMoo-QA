...
void main() {
  group('test responsive utils', () {
    ...
    testWidgets(
      'where fontSize is queried then it scales based on base width',
      (tester) async {
        // 800 / 375 = 2.1333
        await tester.pumpWidget(
          MaterialApp(
            home: Builder(
              builder: (context) {
                expect(
                  ResponsiveUtils.fontSize(context, 10),
                  closeTo(21.33, 0.01),
                );
                return Container();
              },
          ...
          MaterialApp(
            home: Builder(
              builder: (context) {
                ...
                final p2 = ResponsiveUtils.responsivePadding(
                  context,
                  horizontal: 10,
                  vertical: 5,
                );
                ...
                final p3 = ResponsiveUtils.responsivePadding(
                  context,
                  left: 1,
                  top: 2,
                  right: 3,
